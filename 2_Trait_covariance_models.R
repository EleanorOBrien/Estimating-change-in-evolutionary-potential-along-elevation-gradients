...
dat_Pal$Vial_CT <- as.factor(dat_Pal$Vial_CT)
dat_Pal$Vial_HT <- as.factor(dat_Pal$Vial_HT)
dat_Pal$Observer_HT <- as.factor(dat_Pal$Observer_HT)
dat_Pal$Cross_CT_HT <- as.factor(dat_Pal$Cross_CT_HT)
dat_Pal$Cross_WS <- as.factor(dat_Pal$Cross_WS)
dat_Pal$Replicate_CT_HT <- as.factor(dat_Pal$Replicate_CT_HT)
dat_Pal$Replicate_WS <- as.factor(dat_Pal$Replicate_WS)
...
dat_Dan$Vial_CT <- as.factor(dat_Dan$Vial_CT)
dat_Dan$Vial_HT <- as.factor(dat_Dan$Vial_HT)
dat_Dan$Observer_HT <- as.factor(dat_Dan$Observer_HT)
dat_Dan$Cross_CT_HT <- as.factor(dat_Dan$Cross_CT_HT)
dat_Dan$Cross_WS <- as.factor(dat_Dan$Cross_WS)
dat_Dan$Replicate_CT_HT <- as.factor(dat_Dan$Replicate_CT_HT)
dat_Dan$Replicate_WS <- as.factor(dat_Dan$Replicate_WS)
